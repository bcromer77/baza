...
// Static method to create pricing document
...
// Static method to find influencer pricing
PricingSchema.statics.findInfluencerPricing = async function (userId) {
  return this.find({}).select('prismSellPrice influencerSellPrice influencerMargin hotelId eventId currency');
};
